...
namespace FincaFenix.UserInterface7._0.Components.DetailWorkOrder.Consumptions
{
    public partial class RecipeConsumption
    {
        ...
        [Parameter] public decimal TotalApplication { get; set; }
        [Parameter] public bool ShowToolBar { get; set; } = true;
        [Parameter] public bool ShowDetailProduct { get; set; } = true;
        [Parameter] public bool ShowTableConsumption { get; set; } = true;

        private decimal _totalPerformance;
        private decimal _totalApplication;
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            _totalApplication = TotalApplication;
        }

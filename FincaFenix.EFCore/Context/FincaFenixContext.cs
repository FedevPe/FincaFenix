...
namespace FincaFenix.EFCore.Context
{
    public class FincaFenixContext : DbContext
    {
        ...
        private readonly string localServer = "Data Source=FEDEPC\\SQLEXPRESS;Initial Catalog=FincaFenixDB;User ID=sa;Password=Axoft2016;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False";
